      ...
      child: Transform(
        ...
        child: Center(
          child: Container(
            width: 232,
            height: 200,
            color: animation.transform(animationValue) < .5 ? Colors.orange[200] : Colors.orange,
            child: animation.transform(animationValue) < .5 ? Container() :
            Center(
              child: Transform(
                transform: Matrix4.identity()
                ..translate(0.0, 100.0)
                ..rotateX(math.pi * 3),
                child: Image.asset('images/nike.png', height: 100, color: Colors.white,),
              ),
            ),
          ),
        ),
  ...
  Widget buildBoxDoorTop(Size size) {
    return Positioned(
      ...
      child: Transform(
        ...
        ..scale(.9 + .1 * (1 - animationValue), .9 + .1 * (1 - animationValue))
